...
public class QueryScheDetailForRule extends HttpServlet {

	private static final long serialVersionUID = 1L;
	private static Logger logger = Logger.getLogger(QueryScheDetailForRule.class);
	
	public QueryScheDetailForRule() {
