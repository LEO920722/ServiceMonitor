...
var WeekDay=new Array("Sun","Mon","Tue","Web","Thu","Fri","Sat");  
var strToday="";  
var strYear="";  
var strMonth="";  
var strDay="";  
...
function fDrawCal(iYear,iMonth,iCellHeight,iDateTextSize){  
    ...
    var styleTD=" valign='middle' align='center' style='height:"+iCellHeight+"px !important;font-weight:normal;font-size:"+iDateTextSize+"px;";  
    var dateCal="";  
    dateCal+="<tr>";  
    for(var i=0;i<7;i++){  
        dateCal+="<td "+colorTD+styleTD+"color:#006F97'>"+WeekDay[i]+"</td>";  
    }  
    dateCal+="</tr>";  
    for(var w=1;w<7;w++){  
        dateCal+="<tr>";  
...
function getDateDiv(){  
    ...
    dateDiv+="<tr>";  
    dateDiv+="<td><input type='button' id='PrevMonth' value='<' style='height:20px;width:20px;font-weight:normal;border:none' onclick='fPrevMonth()'>";  
    dateDiv+="</td><td><select id='tbSelYear' style='border:none;' onchange='fUpdateCal($V(\"tbSelYear\"),$V(\"tbSelMonth\"))'>";  
    for(var i=startYear;i<endYear;i++){  
        dateDiv+="<option value='"+i+"'>"+i+strYear+"</option>";  
    }  
    dateDiv+="</select></td><td>";  
    dateDiv+="<select id='tbSelMonth' style='border:none;' onchange='fUpdateCal($V(\"tbSelYear\"),$V(\"tbSelMonth\"))'>";  
    for(var i=0;i<12;i++){  
        dateDiv+="<option value='"+(i+1)+"'>"+gMonths[i]+"</option>";  
    }  
    dateDiv+="</select></td><td>";  
    dateDiv+="<input type='button' id='NextMonth' value='>' style='height:20px;width:20px;font-weight:normal;border:none' onclick='fNextMonth()'>";  
